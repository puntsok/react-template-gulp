...
var HelloWorld = React.createClass({
	...
	render: function render() {
		return React.createElement("p", null, "Hello, ", this.props.name, " (", this.state.count, ")", React.createElement("button", { onClick: this.add }, "+"));
	},
...
ReactDOM.render(React.createElement(HelloWorld, { name: 'Person' }), document.getElementById('HelloWorld'));

},{"./HelloWorld.js":159,"react":158,"react-dom":2}]},{},[160]);
